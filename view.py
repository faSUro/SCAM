...
class ViewThread(Thread):
    ...
    def run(self):
        ...
        for i in range(len(lib.interesting_crypto)):
            name_frame = Frame(master=window, bg='black')
            ...
            price_frame = Frame(master=window, bg='black')
            ...
            trend_frame = Frame(master=window, bg='black')
            ...
            self.crypto_labels[lib.interesting_crypto[i]] = {'name': name_label, 'price': price_label,
                                                             'trend': trend_label}
